...
@onready var card_container: VBoxContainer = $MarginContainer/ScrollContainer/VBoxContainer
...
func add_card(card: Card) -> void:
    var card_ui = preload("res://features/cards/card_area_card_ui.tscn").instantiate()
    card_ui.card_area_card_selected.connect(_on_card_area_card_ui_card_area_card_selected)
    card_ui.card_area_card_unselected.connect(_on_card_area_card_ui_card_area_card_unselected)
    card_ui.card_area_card_hovered.connect(_on_card_area_card_ui_card_area_card_hovered)
    card_ui.card_area_card_hovered_exited.connect(_on_card_area_card_ui_card_area_card_hovered_exited)
    card_ui.card = card
